...
namespace AI
{
    ...
    public class SpatialAStar<TPathNode, TUserContext> where TPathNode : IPathNode<TUserContext>
    {
        ...
        /// </summary>
        public LinkedList<TPathNode> Search(int inStartNodeX, int inStartNodeY, int inEndNodeX, int inEndNodeY, TUserContext inUserContext)
        {
            PathNode startNode = m_SearchSpace[inStartNodeX, inStartNodeY];
            PathNode endNode = m_SearchSpace[inEndNodeX, inEndNodeY];
